...
<body>
  ...
  <nav class="navbar bg-body">
    <div class="container">
      ...
      <button type="button" class="btn btn-primary disabled"><a class="text-white text-decoration-none" href="login.html"><i class="fa-solid fa-right-to-bracket text-white"></i> Login</a></button>
    </div>
  </nav>
  <!-- Navbar End -->
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="input-group">
                    <input type="text" name="list" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="Tugas kamu">
                  </div>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                  <button type="submit" class="btn btn-primary" data-bs-dismiss="modal"><i class="fa-solid fa-floppy-disk"></i> Save</button>
                </div>
        </form>
      </div>
    </div>
        ...
        ?>
          ...
          <ul class="list-group" id="task-list">
            <li class="list-group-item d-flex mb-3 align-items-center">
              ...
              <?php echo $row['list'] ?>
              <a href="#" class="btn btn-primary btn-sm ms-auto me-2 edit-button" type="button" data-bs-toggle="modal" data-bs-target="#editModal" data-taskid="<?php echo $row['id']; ?>"><i class=" fa-regular
                fa-pen-to-square"></i></>
                <!-- <button class="btn btn-danger btn-sm" type="button"><i class="fa-solid fa-delete-left"></i></button> -->
                <a href="delete.php? ID= <?php echo $row['id'] ?>" class="btn btn-danger btn-sm" type=""><i class="fa-solid fa-delete-left"></i></a>
            </li>
          </ul>
        <?php
        }
  ...
  <script>
    ...
    for (var i = 0; i < editButtons.length; i++) {
      editButtons[i].addEventListener("click", function() {
        ...
        // Isi input edit dengan nama tugas yang ada saat ini
